                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-[#64748b] max-w-sm mb-8">
                            ScaleUp Co provides professional websites and growth systems designed to bring more customers, more calls, and more revenue for local businesses.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li><Link to="/services/web-development" className="text-[#64748b] hover:text-white transition-colors text-sm">Website Development</Link></li>
                            <li><Link to="/services/seo" className="text-[#64748b] hover:text-white transition-colors text-sm">SEO & Visibility</Link></li>
                            <li><Link to="/services/lead-generation" className="text-[#64748b] hover:text-white transition-colors text-sm">Lead Gen Systems</Link></li>
                            <li><Link to="/services/ai-chatbots" className="text-[#64748b] hover:text-white transition-colors text-sm">AI Chatbots</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link to="/portfolio" className="text-[#64748b] hover:text-white transition-colors text-sm">Portfolio</Link></li>
                            <li><Link to="/industries" className="text-[#64748b] hover:text-white transition-colors text-sm">Industries</Link></li>
                            <li><Link to="/blog" className="text-[#64748b] hover:text-white transition-colors text-sm">Blog</Link></li>
                        </ul>
                    </div>
